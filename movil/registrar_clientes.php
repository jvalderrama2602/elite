...
$pass_mostrar = $_POST['pass1'];

	$sql60 = "SELECT idclientes FROM pbrh_users WHERE usuario='$usuario' OR email='$email' limit 1";
	$result60 = $conex->query($sql60);
	$fila60 = $result60 -> fetch_array();

if($fila60[idclientes]!="")
{
	$valor = 1;
}
else
{
	...
	$insertarUsuario = "INSERT INTO pbrh_users(usuario,password,email,ingresa,nombre,cambio) VALUES('$usuario','$pass1','$email','0','$nombre','1')";
	$resultadoInsertar = mysqli_query($conex, $insertarUsuario)or die(mysqli_error($db)); 
	...
	$mail->AddAddress($fila61[email_envio]);
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                      ...
                      <td width="503" align="left" valign="top">
                        <div class="contentEditableContainer contentTextEditable">
                          <div class="contentEditable" >
                            <p style="font-size:13px;">Gracias por registrate '.$nombre.', nuestras escorts evaluaran tu solicitud y pronto recibiras un Email con la respuesta.</p>
                            <br>
                            <span style="font-size:13px;">
                              <p >Recuerde que su datos de registro son los siguientes:</p>
                              <p>Usuario:&nbsp;&nbsp;&nbsp;'.$usuario.'</p>
                              <p>Password:&nbsp;&nbsp;&nbsp;'.$pass_mostrar.'</p>
                            </span>
                          </div>
                        </div>
                      </td>
    ...
    <tr>
      ...
      <tr>
        <td valign="top" align="center">
          <div class="contentEditableContainer contentTextEditable">
            <div class="contentEditable" >
              <p style="color:#A8B0B6; font-size:13px;line-height: 16px;">Este correo electrónico se envió a [correo electrónico] cuando se registró en [CLIENTS.WEBSITE] Por favor, agréguenos a sus contactos para asegurarse de que los boletines informativos lleguen a su bandeja de entrada.
              </p>
            </div>
          </div>
        </td>
